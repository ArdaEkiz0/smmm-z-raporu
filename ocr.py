...
def duzeltme_uygula(text):
    ...
    turkce_patterns = [
        ...
        (r'\b[ÜU]R[ÜU]N(?=[Ll][Ee][Rr][İI1]?\b|\b)', 'ÜRÜN'),
        ...
        (r'TOPLAM\s+[SXZsxz](?=\d|\s|$)', 'TOPLAM %'),
        (r'KDV\s+[SXZsxz](?=\d|\s|$)', 'KDV %'),
        (r'\bMktr\b', '%'),
        ...
        (r'\bGOKKUSAS[İI1]\b', 'GÖKKUŞAĞI'),
        (r'\bGOKKUSAGI[İI1]\b', 'GÖKKUŞAĞI'),
        (r'TOPKDU\s+[XZ]\s*[lI1]\b', 'TOPKDV %1'),
        (r'TOPKDU\s+[XZ]\s*10\b', 'TOPKDV %10'),
        (r'TOPKDU\s+[XZ]\s*20\b', 'TOPKDV %20'),
        (r'TOPKDU\s+[XZ]\s*0\b', 'TOPKDV %0'),
        (r'\bTOPKDU\s+(?=[\d.,\s])', 'TOPKDV '),
        (r'TOPKDV\s+[XZ]\s*[lI1]\b', 'TOPKDV %1'),
        (r'TOPKDV\s+[XZ]\s*10\b', 'TOPKDV %10'),
        (r'TOPKDV\s+[XZ]\s*20\b', 'TOPKDV %20'),
        (r'TOPKDV\s+[XZ]\s*0\b', 'TOPKDV %0'),
        (r'TOPLAM\s+KDV\s*\.?\s*[XZ]\s*([0-9]+)', r'TOPLAM KDV %\1'),
        (r'\bTOPLAM\s*[XZ]\s*([lI1])\b', r'TOPLAM %\1'),
        (r'\bTOPLAM\s+[XZ]\s*(10|20|0)\b', r'TOPLAM %\1'),
        (r'\bTOPLAM\s+[XZ]\s*([lI1])\b', r'TOPLAM %\1'),
        (r'\bKUM[\s.\-]*TCP\s*LAM\b', 'KÜM.TOPLAM'),
        (r'\bKUM[\s.\-]*TCP\s*KDV\b', 'KÜM.TOPKDV'),
        (r'\bKUM\s*\.?\s*TCPLAM\b', 'KÜM.TOPLAM'),
        (r'\bKUM\s*\.?\s*TCPKDV\b', 'KÜM.TOPKDV'),
        (r'\bUNDEŞ[İI1]M\b', 'İNDEKSİM'),
        (r'\bTOPLAM\s*TAH[S5][İI1][LŁ][4A][T7]\b', 'TOPLAM TAHSİLAT'),
        (r'\bTAH[S5][İI1][LŁ][4A][T7]\s*[T7][O0][P][LŁ][4A][M][İI1]\b', 'TAHSİLAT TOPLAMI'),
        (r'\bNET[T7][O0][P][LŁ][4A][M]\b', 'NET TOPLAM'),
        (r'\bNET[T7][UÜ][T7][4A][R8]\b', 'NET TUTAR'),
        (r'\b[6G][E3][N][E3][LŁ]\s*[T7][O0][P][LŁ][4A][M]\b', 'GENEL TOPLAM'),
        (r'\b[4A][R8][4A]\s*[T7][O0][P][LŁ][4A][M]\b', 'ARA TOPLAM'),
        (r'\b[İI1][N][D][İI1][R8][İI1][M]\b', 'İNDİRİM'),
        (r'\b[İI1][S5][K][O0][N][T7][O0]\b', 'İSKONTO'),
        (r'\b[P8][R8][O0][M][O0][S5][Y][O0][N]\b', 'PROMOSYON'),
        (r'\b[MN][UÜ][S5][T7][E3][R8][İI1]\s*[Nn][O0]\b', 'MÜŞTERİ NO'),
        (r'\b[İI1][ŞS][LŁ][E3][M]\s*[Nn][O0]\b', 'İŞLEM NO'),
        (r'\b[B8][E3][LŁ][6G][E3]\s*[Nn][O0]\b', 'BELGE NO'),
        (r'\b[Ff][4A][T7][UÜ][R8][4A]\s*[Nn][O0]\b', 'FATURA NO'),
        (r'\b[İI1][R8][S5][4A][LŁ][İI1][Y][E3]\s*[Nn][O0]\b', 'İRSALİYE NO'),
        (r'\b[S5][İI1][P8][4A][R8][İI1][ŞS]\s*[Nn][O0]\b', 'SİPARİŞ NO'),
        (r'\b[Kk][4A][R8][T7]\s*[Nn][O0]\b', 'KART NO'),
        (r'\b[T7][E3][R8][MN][İI1][N4A][LŁ]\s*[Nn][O0]\b', 'TERMİNAL NO'),
        (r'\b[B8][4A][Yy][İI1]\s*[Nn][O0]\b', 'BAYİ NO'),
        (r'\b[İI1][ŞS][Y][E3][R8][İI1]\s*[Nn][O0]\b', 'İŞYERİ NO'),
        (r'\b[Vv][E3][Zz][Nn][E3][Dd][4A][R8]\b', 'VEZNEDAR'),
        (r'\b[Gg][İI1][ŞS][E3]\b', 'GİŞE'),
        (r'\b[ŞS][UÜ][B8][E3]\b', 'ŞUBE'),
        (r'\b[B8][4A][Nn][Kk][4A]\b', 'BANKA'),
        (r'\b[Hh][E3][S5][4A][P8]\b', 'HESAP'),
        (r'\b[Tt][4A][Kk][S5][İI1][Tt]\b', 'TAKSİT'),
        (r'\b[MN][İI1][Kk][Tt][4A][R8]\b', 'MİKTAR'),
        (r'\b[B8][İI1][R8][İI1][MN]\b', 'BİRİM'),
        (r'\b[4A][Dd][E3][Tt]\b', 'ADET'),
        (r'\b[Kk][Dd][Vv]\s*[O0][R8][4A][Nn][İI1]\b', 'KDV ORANI'),
        (r'\b[Kk][Dd][Vv]\s*[Tt][UÜ][Tt][4A][R8][İI1]\b', 'KDV TUTARI'),
        (r'\b[Kk][Dd][Vv]\s*[MN][4A][Tt][R8][4A][Hh][İI1]\b', 'KDV MATRAHI'),
        (r'\b[Tt][O0][Pp][LŁ][4A][MN]\s*[Kk][Dd][Vv]\b', 'TOPLAM KDV'),
        (r'\b[Gg][E3][Nn][E3][LŁ]\s*[Tt][O0][Pp][LŁ][4A][MN]\b', 'GENEL TOPLAM'),
        (r'\b[Yy][E3][MN][E3][Kk]\s*[ÇC][E3][Kk][İI1]\b', 'YEMEK ÇEKİ'),
        (r'\bYEMEK[\s-]?[Kk][4A][R8][Tt][İI1]\b', 'YEMEK KARTI'),
        (r'\b[Ff][İI1][Yy][4A][Tt]\b', 'FİYAT'),
        (r'\b[Kk][O0][Dd]\b', 'KOD'),
        (r'\b[B8][4A][R8][Kk][O0][Dd]\b', 'BARKOD'),
        (r'\b[Pp][LŁ][UÜ]\b', 'PLU'),
        (r'\b[Kk][4A][Ss][4A]\b', 'KASA'),
        (r'\b[MN][4A][Kk][B8][UÜ][Zz]\b', 'MAKBUZ'),
        (r'\b[İI1][Pp][Tt][4A][LŁ]\s*[Tt][UÜ][Tt][4A][R8][İI1]\b', 'İPTAL TUTARI'),
        (r'\b[ÇC][O0][Kk]\s*[Tt][UÜ][Tt][4A][R8]\b', 'ÇOK TUTAR'),
        (r'\b[Gg][İI1][R8][İI1][ŞS]\b', 'GİRİŞ'),
        (r'\b[ÇC][İI1][Kk][İI1][ŞS]\b', 'ÇIKIŞ'),
        (r'\b[Yy][4A][Zz][İI1][ÇC][İI1]\b', 'YAZICI'),
        (r'\b[İI1][MN][Zz][4A]\b', 'İMZA'),
        (r'\b[Yy][E3][Tt][Kk][İI1][LŁ][İI1]\b', 'YETKİLİ'),
        (r'\b[S5][4A][Yy][İI1][Nn]\b', 'SAYIN'),
        (r'\b[Kk][4A][Pp][4A][Tt][MN][4A]\b', 'KAPATMA'),
    ]
