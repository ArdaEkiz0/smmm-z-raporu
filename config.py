...
BANKA_REGEX = [
    ...
    (r'AK\s*BANK', "Akbank"),
    (r'YAPI\s*KRED[İI]', "Yapı Kredi"),
    (r'HALK\s*BANK', "Halkbank"),
    (r'VAKIF\s*BANK', "Vakıfbank"),
    (r'DENIZ\s*BANK', "Denizbank"),
    (r'F[İI]NANS\s*BANK', "QNB Finansbank"),
    (r'QNB\s*BEL[O0]', "QNB Finansbank"),
    (r'Z[İI]RAAT', "Ziraat"),
    (r'HSBC', "HSBC"),
    (r'ING', "ING Bank"),
    (r'TEB\b', "TEB"),
    (r'T[ÜU]RK[İI]YE\s*EKONOM[İI]\s*BANKAS[İI]', "TEB"),
    (r'PTT\b', "PTT"),
    (r'ALBARAKA', "Albaraka"),
    (r'KUVEYT\s*T[ÜU]RK', "Kuveyt Türk"),
    (r'ANADOLU\s*BANK', "Anadolubank"),
]
